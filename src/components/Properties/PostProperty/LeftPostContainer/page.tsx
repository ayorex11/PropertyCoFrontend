...
import { postPropertyApi } from "@/lib/api/propertiesApi";
...
const LeftPostProperty = () => {
  ...
  const onSubmit = async (data: PropertyFormPayload) => {
      try {
          await postPropertyApi(data);
          await dispatch(fetchProperties());
          successToast("Property Posted successfully");
        } catch (err: unknown) {
...
export default LeftPostProperty;
