...
const MobileAgentSidebar = () => {
  ...
  const NavElements = [
    { href: "/dashboard/agent", name: "Overview", icon: PiBinoculars },
    {
    ...
    { href: "/dashboard/agent/security", name: "Security", icon: FiSettings },
                          ...
                          >
                            <Box>
                              <HStack>
                                ...
                                {eachElement.count ? eachElement.count > 0 && (
